...
const ColorSwitch = () => {
    const [isThemeLuxury, setIsThemeLuxury] = useState(false);

    const toggleTheme = () => {
        setIsThemeLuxury(!isThemeLuxury);
        const newTheme = isThemeLuxury ? 'lemonade' : 'luxury';
        document.documentElement.setAttribute('data-theme', newTheme);
    };

    return (
        <label className="swap swap-rotate">
            <input type="checkbox" onChange={toggleTheme} checked={!isThemeLuxury} />
