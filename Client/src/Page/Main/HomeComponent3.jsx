...
const HomeComponent3 = () => {
    ...
    useEffect(() => {
        const fetchTestimonials = async () => {
            try {
                const response = await axios.get('https://epics-final-i5eq.vercel.app/api/testimonials');
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://epics-final-i5eq.vercel.app/api/testimonials/${id}`);
